...
\begin{figure}[htbp]
  ...
  \caption{Representative response of the ionic-liquid tactile sensor during a grasp trial. The plot shows the sensor signal (normalized units) over time, highlighting contact events as rapid changes and the baseline stability after calibration to remove temperature-dependent drift.}
