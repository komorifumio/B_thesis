...
\subsubsection{タスクの教示，学習条件}
実験セットアップをFig.~\ref{fig:experiment_setup}に示す．単腕での操作を補助するため，折り紙の片側を固定する専用の治具（Fig.~\ref{figC:jig_photographs}）を作製した．タスクの目標は，机上の治具に固定された折り紙を把持し，谷折りにして折り目をつけることである．治具には固定用のピンが設けられており，ロボットが紙を折り返したタイミングで，人間が紙をピンに差し込み固定を行う．
