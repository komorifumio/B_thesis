...
教示データは，キムタオルをFig3.1においてある場所にある枚数置いておき，リーダーアームでその上から１枚だけとって紺色の障害物の左側に離す動作をテレオペレーションで行い収集した．この時，双腕や箱を想定した障害物により横からのカメラではキムタオルの高さが見えない．その上，目の前にある障害物を避けてキムタオルへのアプローチをする必要があり，7自由度でないと実現が難しい．\par
...
さらに，指先のソフトフィンガーの長さを教示時とは短くしたものでも評価を行った．1つ目は教示データと同じ状態，2つ目はそれよりも指の長さが30mm短い状態である．\par
...
\begin{figure}[htbp]
  ...
  \caption{治具の写真：左から治具単体，紙1枚装着，紙2枚装着．}
