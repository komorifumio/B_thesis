...
この幾何学的な変化は，イオン液体固有の電気抵抗率 $\rho$ を用いて，抵抗値 $R$ が次式のように表されることによって検出される\cite{chossatSoftStrainSensor2013}．
\begin{equation}
  R = \rho \frac{L}{A}
\end{equation}


Fig.~\ref{fig:soft_finger}にソフトフィンガーの写真を示す．平行リンク機構を用いた2指平行グリッパであり，2つのセンサ情報を受け取る．\par
