...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiyoko1.pdf}
    \caption*{\#1}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiyoko2.pdf}
    \caption*{\#2}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiyoko3.pdf}
    \caption*{\#3}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiyoko4.pdf}
    \caption*{\#4}
  \end{subfigure}
  ...
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiyoko5.pdf}
    \caption*{\#5}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiyoko6.pdf}
    \caption*{\#6}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiyoko7.pdf}
    \caption*{\#7}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiyoko8.pdf}
    \caption*{\#8}
  \end{subfigure}
  ...
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiyoko9.pdf}
    \caption*{\#9}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiyoko10.pdf}
    \caption*{\#10}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiyoko11.pdf}
    \caption*{\#11}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiyoko12.pdf}
    \caption*{\#12}
  \end{subfigure}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiue1.pdf}
    \caption*{\#1}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiue2.pdf}
    \caption*{\#2}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiue3.pdf}
    \caption*{\#3}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiue4.pdf}
    \caption*{\#4}
  \end{subfigure}
  ...
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiue5.pdf}
    \caption*{\#5}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiue6.pdf}
    \caption*{\#6}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiue7.pdf}
    \caption*{\#7}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiue8.pdf}
    \caption*{\#8}
  \end{subfigure}
  ...
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiue9.pdf}
    \caption*{\#9}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiue10.pdf}
    \caption*{\#10}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiue11.pdf}
    \caption*{\#11}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.24\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tex/Image/kamiue12.pdf}
    \caption*{\#12}
  \end{subfigure}
